...
<html lang="en">
  ...
  <body>
   ...
   .dropdown .dropdown-menu a:hover{color: red;background-color: #5547F0}
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown language-dropdown">
              <a class="nav-link dropdown-toggle  d-flex align-items-center" id="LanguageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <span class="profile-text font-weight-medium d-none d-md-block">
                  English
                </span>
              </a>
              <div class="dropdown-menu dropdown-menu-left navbar-dropdown mt-0"  aria-labelledby="LanguageDropdown">
                <a href="#" class="dropdown-item p-2">
                  English
                </a>
                <a href="1"  class="dropdown-item p-2">
                  English
                </a>
                <a href="2"  class="dropdown-item p-2">
                  English
                </a>
                <a href="3"  class="dropdown-item p-2">
                  English
                </a>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list mt-0 " aria-labelledby="messageDropdown">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list  mt-0" aria-labelledby="notificationDropdown">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown  mt-0" aria-labelledby="UserDropdown">
